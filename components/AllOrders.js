...
const AllOrders = () => {
                            ...
                            <Row gutter={[16, 16]} style={{
                                ...
                                <Col span={12} style={{
                                    ...
                                    <Row style={{
                                        ...
                                        <h4>Customer Name: {
                                            orderDetails.customer_mave?.full_name ? orderDetails.customer_mave?.full_name : "N/A"
                                        }</h4>
                                    </Row>
                                    <Row style={{
                                        borderBottom: "1px solid #ccc",
                                        ...
                                        <h4>Customer Phone: {
                                            orderDetails.customer_mave?.phone ? orderDetails.customer_mave?.phone : "N/A"
                                        }</h4>
                                    </Row>
                                    <Row style={{
                                        borderBottom: "1px solid #ccc",
                                        ...
                                        <h4>Customer Email: {
                                            orderDetails.customer_mave?.email ? orderDetails.customer_mave?.email : "N/A"
                                        }</h4>
                                    </Row>
                                    <Row style={{
                                        borderBottom: "1px solid #ccc",
                                        ...
                                        <h4>Customer Address: {
                                            orderDetails.customer_mave?.address_line_1 ? orderDetails.customer_mave?.address_line_1 : "N/A"
                                        }</h4>
                                    </Row>
                                    {/* message */}
                                    <Row style={{
                                ...
                                <Col span={12}>
                                    <Row style={{
                                        ...
                                        <h4>Order ID: {
                                            orderDetails.id ? orderDetails.id : "N/A"
                                        }</h4>
                                    </Row>
                                    <Row style={{
                                        borderBottom: "1px solid #ccc",
                                        ...
                                        <h4>Order Date: {
                                            orderDetails.customer_mave?.created_at ?
                                                moment(orderDetails.customer_mave?.created_at).format("DD/MM/YYYY") : "N/A"
                                        }</h4>
                                    </Row>
                                    <Row style={{
                                        borderBottom: "1px solid #ccc",
                                        ...
                                        <h4>Gas Type: {
                                            orderDetails.order_details?.type ? (
                                                orderDetails.order_details?.type === "cylinder_gas" ? "Cylinder Gas" : (
                                                    orderDetails.order_details?.type === "auto" ? "Auto Gas" : (
                                                        orderDetails.order_details?.type === "bulk" ? "Bulk Gas" : "N/A"
                                                    )
                                                )
                                            ) : "N/A"
                                        }</h4>
                                    ...
                                    <Row style={{
                                        ...
                                        <h4>Order Status: </h4>
                                        {
                                            orderDetails.order_status ? (
                                                <h3
                                                    style={{
                                                        color: orderDetails.order_status === "Approved" ? "green" : (
                                                            orderDetails.order_status === "Declined" ? "red" : "orange"
                                                        ),
                                                        backgroundColor: orderDetails.order_status === "Approved" ? "#e6ffe6" : (
                                                            orderDetails.order_status === "Declined" ? "#ffe6e6" : "#ffffcc"
                                                        ),
                                                        padding: "0.5em 1em",
                                                        borderRadius: "5px",
                                                        width: "fit-content",
                                                ...
                                                >
                                                    {
                                                        orderDetails.order_status ? orderDetails.order_status : "Pending"
                                                    }
                                                </h3>
                                            ) : (
                                                <h3 style={{
                                ...
                                <h3>
                                    Total Amount: {
                                        orderDetails?.total_amount ? orderDetails?.total_amount : (
                                            orderDetails?.order_details?.unit_price ? orderDetails?.order_details?.unit_price : "N/A"
                                        )
                                    }</h3>
                            </Row>
                        </>
    ...
    const sortByName = (a, b) => {
        if (isAscending) {
            return a.customer_mave?.full_name.localeCompare(b.customer_mave?.full_name);
        } else {
    ...
    const searchByNameOrPhone = (e) => {
        ...
        const filteredOrders = allOrders.filter((order) => {
            return order.customer_mave?.full_name.toLowerCase().includes(value.toLowerCase()) || order.customer_mave?.phone.toLowerCase().includes(value.toLowerCase());
        });
        ...
        allOrders.forEach((order) => {
            csvContent.push([
                ...
                order.order_details?.type ? (
                    order.order_details?.type === "cylinder_gas" ? "Cylinder Gas" : (
                        order.order_details?.type === "auto" ? "Auto Gas" : (
                            order.order_details?.type === "bulk" ? "Bulk Gas" : "N/A"
                        )
                    )
                ) : "N/A",
                order.order_details?.type_of_service ? order.order_details?.type_of_service : "N/A",
                order.total_amount ? order.total_amount : (
                    order.order_details?.unit_price ? order.order_details?.unit_price : "N/A"
                )
            ].join(","));
        }
        );
