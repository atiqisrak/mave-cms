            ...
            if (e.target.value == "") {
              ...
              setDealers(
                dealers.filter((dealer) => {
                  return dealer?.dealer_mave?.full_name
                    .toLowerCase()
      ...
      {dealers.map((dealer, index) => {
        return (
          ...
          >
            ...
            <Col span={4}>
              <p>{dealer?.dealer_mave?.full_name}</p>
            </Col>
            <Col span={3}>
              <p>{dealer?.dealer_mave?.phone}</p>
            </Col>
            <Col span={3}>
              <p>{dealer?.dealer_mave?.thana}</p>
            </Col>
            <Col span={3}>
              <p>{dealer?.dealer_mave?.district}</p>
            </Col>
            <Col span={3}>
              <p>{moment(dealer?.created_at).format("DD-MM-YYYY")}</p>
            </Col>
            <Col span={1}>
                  ...
                  >
                    ...
                    <Row>
                      ...
                      >
                        ...
                        >
                          <h4>Name: </h4>
                          {selectedDealer?.dealer_mave?.full_name}
                        </Row>
                        <Row
                          style={{
                            display: "grid",
                        ...
                        >
                          <h4>Phone: </h4>
                          {selectedDealer?.dealer_mave?.phone}
                        </Row>
                        <Row
                          style={{
                            display: "grid",
                        ...
                        >
                          ...
                          {
                            selectedDealer?.dealer_mave?.additionals
                              ?.contactPerson
                          }
                        </Row>
                        <Row
                        ...
                        >
                          <h4>Address 1: </h4>
                          {selectedDealer?.dealer_mave?.address_line_1}
                        </Row>
                        <Row
                          style={{
                            display: "grid",
                        ...
                        >
                          <h4>Address 2: </h4>
                          {selectedDealer?.dealer_mave?.address_line_2}
                        </Row>
                        <Row
                          style={{
                            display: "grid",
                        ...
                        >
                          <h4>Thana: </h4>
                          {selectedDealer?.dealer_mave?.thana}
                        </Row>
                        <Row
                          style={{
                            display: "grid",
                        ...
                        >
                          <h4>District: </h4>
                          {selectedDealer?.dealer_mave?.district}
                        </Row>
                      </Col>
                      <Col
                        span={12}
                      ...
                      >
                        ...
                        >
                          <h4>Sales Volume: </h4>
                          {
                            // Float to integer
                            Math.round(
                              selectedDealer?.dealer_mave?.monthly_sales_volumn
                            )
                          }{" "}
                          Metric Ton/Taka
                        </Row>
                        ...
                        >
                          <h4>Order Date: </h4>
                          {selectedDealer?.dealer_mave?.created_at}
                        </Row>
                        <Row
                          style={{
                            display: "grid",
                        ...
                        >
                          ...
                          <h4
                            style={{
                              backgroundColor:
                                selectedDealer?.dealer_mave?.status == 0
                                  ? "green"
                                  : "orange",
                              color: "#fff",
                              padding: "0.3em 0.6em",
