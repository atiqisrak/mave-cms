    ...
    return (
        <div className="ViewContainer">
            <div className="ViewContentContainer">
                ...
                <Button type="primary" onClick={handleRemoveBackground}
                    style={{
                        marginTop: "2em",
            ...
            <div className="ConvertedImages" style={{
                display: "flex",
                ...
                <div>
                    ...
                    {image && <Image
                        ...
                        style={{
                            objectFit: "cover",
                            borderRadius: "20px"
                        }} src={URL.createObjectURL(image)} alt="Uploaded" />}
                </div>
                <div>
                    <h2 style={{
                        paddingBottom: "2em"
                    ...
                    {convertedImage
                        && <Image
                            ...
                            style={{
                                objectFit: "cover",
                                borderRadius: "20px"
                            }} src={convertedImage} alt="Converted" />}
                    {convertedImage && (
                        <center><Button
                            style={{
                                marginTop: "2em",
