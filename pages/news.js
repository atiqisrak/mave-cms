                                                        ...
                                                        editMode ? (
                                                            <>
                                                                ...
                                                                <Select
                                                                    ...
                                                                    onChange={(value) => handleFormChange('event_ids', value)}
                                                                >
                                                                    {
                                                                        events?.map((event) => (
                                                            ...
                                                            <>
                                                                <h2>
                                                                    Title (English): {newsPage?.title_en}
                                                                </h2>
                                                                <h2>
                                                                    Title (Bangla): {newsPage?.title_bn}
                                                                </h2>
                                                            ...
                                                            <div dangerouslySetInnerHTML={{ __html: newsPage?.description_bn }} /> */}
                                                                ...
                                                                <div className="PressRelease">
                                                                    <h3 style={{
                                                                        ...
                                                                        Press Release Title (English): {newsPage?.press_release_mave?.title_en}
                                                                        Press Release Title (Bangla): {newsPage?.press_release_mave?.title_bn}
                                                                    </h3>
                                                                    {
