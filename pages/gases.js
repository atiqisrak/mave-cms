                ...
                <div className="ViewContentContainer">
                        ...
                        createMode ? (
                            <div className="PageBody">
                                <Modal title="Create Gas" open={createMode} onOk={handleCreate} onCancel={() => setCreateMode(false)}>
                                    ...
                                    >
                                        <Image
                                            src={formData?.media_mave ? `${MEDIA_URL}/${formData?.media_mave?.file_path}` : "/images/Image_Placeholder.png"}
                                            style={{
                                                width: "200px",
                                                height: "200px",
                                                objectFit: "cover",
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setFormData({ ...formData, gas_weight: e.target.value })}
                                    />
                                    <Input
                    ...
                    <div className="PageBody">
                        <Row gutter={[16, 16]} style={{
                            ...
                            <Col span={4}><h3>Gas Image</h3></Col>
                            <Col span={4}><h3>Gas Type</h3></Col>
                            <Col span={4}><h3>Gas Weight</h3></Col>
                            <Col span={4}><h3>Unit Price</h3></Col>
                            <Col span={8}><h3>Actions</h3></Col>
                        </Row>
                        {
                            gases?.map((gas, index) => (
                                    ...
                                    <Row gutter={[16, 16]} key={index} style={{
                                        ...
                                        <Col span={8} style={{
                                            ...
                                            <Button type="primary"
                                                ...
                                                onClick={() => handleUpdate(gas.id)}>Update</Button>
                                            <Button danger
                                                style={{
                                                    borderRadius: "10px",
                                                    fontSize: "1.2em",
                                    ...
                                    <Row gutter={[16, 16]} key={index} style={{
                                        ...
                                        <Col span={8} style={{
                                            ...
                                            <Button danger
                                                ...
                                                onClick={() => handleDelete(gas.id)}>Delete</Button>
                                        </Col>
                                    </Row>
                                )
                            ))
